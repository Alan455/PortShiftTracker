...
object DefaultCatalog {
    ...
    fun rules(): List<AllowanceRuleEntity> = buildList {
        ...
        add(fixed("AVV_DIS_CASA_FEST", "Dis.Casa.Fest", 1500, AllowanceCategory.AVVIAMENTO, 104, group = "IMA_DISDETTA"))
        ...
        add(fixed("AVV_DIS_CASA", "Dis.Casa", 1000, AllowanceCategory.AVVIAMENTO, 109, group = "IMA_DISDETTA"))
        ...
        add(fixed("AVV_DS", "Donazione sangue", 9500, AllowanceCategory.ALTRE_VOCI, 512, performanceMask = PerformanceType.TURNO.maskBit))
        add(fixed("AVV_INAIL", "Inail", 6780, AllowanceCategory.ALTRE_VOCI, 513, performanceMask = PerformanceType.TURNO.maskBit))
        add(fixed("AVV_CONGEDO", "Congedo", 3000, AllowanceCategory.ALTRE_VOCI, 514, performanceMask = PerformanceType.TURNO.maskBit))
